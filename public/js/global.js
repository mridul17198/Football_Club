    ...
    socket.on('loggedInUser', function(users){
        ...
        for(var i = 0; i < users.length; i++){
            ...
            if(friend.indexOf(users[i].name) > -1){
                ...
                var list = '<img src="https://footballclubchatapplication.s3.amazonaws.com/'+users[i].img+'" class="pull-left img-circle" style="width:50px; height:50px; margin-right:10px;" /><p>' +
