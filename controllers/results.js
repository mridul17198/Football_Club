module.exports = function(async, Club, Users,FriendResult){
    return {
        ...
        postResults: function(req, res){
            async.parallel([
                ...
                res.render('results', {title: 'FootballClub - Results', user: req.user, chunks: dataChunk});
            })
        },
        ...
        viewMembers: function(req, res){
            async.parallel([
                ...
                res.render('members', {title: 'FootballClub - Members', user: req.user, chunks: dataChunk});
            })
        },
